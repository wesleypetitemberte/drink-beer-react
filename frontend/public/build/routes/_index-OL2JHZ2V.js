...
import {
  createHotContext
} from "/build/_shared/chunk-ECRCOSIY.js";
...
function _listen(query, params) {
  ...
  return new Observable((observer) => {
    ...
    async function getEventSource() {
      const {
        default: EventSource
      } = await import("/build/_shared/browser-ZC4XKKKZ.js");
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1705012353939.864";
}
function Index() {
  _s();
  const [data, setData] = import_react.default.useState(null);
  import_react.default.useEffect(() => {
    sanityClient_default.fetch('*[_type == "bier"]{name, description, image}').then((result) => setData(result)).catch((error) => console.error("Erro ao buscar dados do Sanity:", error));
  }, []);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { children: "Meu Projeto RemixJS e SanityJS" }, void 0, false, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 31,
      columnNumber: 7
    }, this),
    data && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", { children: data.map((item, index) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("li", { children: item.name }, index, false, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 34,
      columnNumber: 38
    }, this)) }, void 0, false, {
...
_s(Index, "fQZRxy/+nAZ7NLS1X4dVhrlp8Go=");
_c = Index;
var _c;
$RefreshReg$(_c, "Index");
...
is-plain-object/dist/is-plain-object.mjs:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/_index-OL2JHZ2V.js.map
