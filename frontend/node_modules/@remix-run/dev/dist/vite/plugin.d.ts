...
export type ResolvedRemixVitePluginConfig = Pick<ResolvedRemixConfig, "appDirectory" | "rootDirectory" | "assetsBuildDirectory" | "entryClientFilePath" | "entryServerFilePath" | "future" | "isSpaMode" | "publicPath" | "relativeAssetsBuildDirectory" | "routes" | "serverModuleFormat"> & {
    serverBuildDirectory: string;
    serverBuildFile: string;
