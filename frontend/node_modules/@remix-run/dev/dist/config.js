...
async function resolveConfig(appConfig, {
  ...
  var _appConfig$future, _appConfig$future2;
  ...
  let future = {
    ...
    v3_relativeSplatPath: ((_appConfig$future2 = appConfig.future) === null || _appConfig$future2 === void 0 ? void 0 : _appConfig$future2.v3_relativeSplatPath) === true
  };
  if (appConfig.future) {
