...
async function getBuildAction() {
  const mod = await import('./buildAction-GMIw1NLB.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-pTdoGBAq.js');
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-kB-DkeFk.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-ZDolivrd.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
//# sourceMappingURL=_internal-nCojw-OA.js.map
