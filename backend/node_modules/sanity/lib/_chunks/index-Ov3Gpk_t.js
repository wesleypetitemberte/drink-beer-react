...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from './structure-QUROXLum.js';
...
const paneMap = {
  component: lazy(() => import('./index-r8DahYH3.js')),
  document: lazy(() => import('./pane-VYAU_MzR.js')),
  documentList: lazy(() => import('./pane-Pe0oiZY1.js')),
  list: lazy(() => import('./index-UevSrBZN.js'))
};
...
//# sourceMappingURL=index-Ov3Gpk_t.js.map
